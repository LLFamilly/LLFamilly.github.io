...
a)||c.curSelectedList.push(a)},addCreatedNode:function(b,a){(b.callback.onNodeCreated||b.view.addDiyDom)&&h.getRoot(b).createdNodes.push(a)},addZTreeTools:function(b){E.push(b)},exSetting:function(b){k.extend(!0,M,b)},fixPIdKeyValue:function(b,a){b.data.simpleData.enable&&(a[b.data.simpleData.pIdKey]=a.parentTId?a.getParentNode()[b.data.simpleData.idKey]:b.data.simpleData.rootPId)},getAfterA:function(b,a,c){for(var d=0,f=B.length;d<f;d++)b[d].apply(this,arguments)},getbeforea:function(b,a,c){for(var d="0,f=A.length;d<f;d++)A[d].apply(this,arguments)},getInnerAfterA:function(b,a,c){for(var" t[b.treeid]},getnextnode:function(b,a){if(!a)return="" null;for(var="" c="b.data.key.children,d=a.parentTId?a.getParentNode():h.getRoot(b),f=0,g=d[c].length-1;f<=g;f++)if(d[c][f]===a)return" f="=g?null:d[c][f+1];return" null},getnodebyparam:function(b,a,="" c,d){if(!a||!c)return="" a[g];var="" e="h.getNodeByParam(b,a[g][f],c,d);if(e)return" e}return="" null},getnodecache:function(b,a){if(!a)return="" null;var="" c?c:null},getnodename:function(b,a){return""+a[b.data.key.name]},getnodetitle:function(b,a){return""+a[b.data.key.title="==""?b.data.key.name:b.data.key.title]},getNodes:function(b){return" h.getroot(b)[b.data.key.children]},getnodesbyparam:function(b,="" a,c,d){if(!a||!c)return[];for(var="" g},getnodesbyparamfuzzy:function(b,a,c,d){if(!a||!c)return[];for(var="" a[l][c]="="string"&&a[l][c].indexOf(d)">-1&&g.push(a[l]),g=g.concat(h.getNodesByParamFuzzy(b,a[l][f],c,d));return g},getNodesByFilter:function(b,a,c,d,f){if(!a)return d?null:[];for(var g=b.data.key.children,l=d?null:
[],e=0,i=a.length;e<i;e++){if(j.apply(c,[a[e],f],!1)){if(d)return a[e];l.push(a[e])}var="" k="h.getNodesByFilter(b,a[e][g],c,d,f);if(d&&k)return" k;l="d?k:l.concat(k)}return" l},getprenode:function(b,a){if(!a)return="" null;for(var="" c="b.data.key.children,d=a.parentTId?a.getParentNode():h.getRoot(b),f=0,g=d[c].length;f<g;f++)if(d[c][f]===a)return" f="=0?null:d[c][f-1];return" null},getroot:function(b){return="" b?l[b.treeid]:null},getsetting:function(b){return="" r[b]},getsettings:function(){return="" r},getztreetools:function(b){return(b="this.getRoot(this.getSetting(b)))?b.treeTools:null},initCache:function(b){for(var" a="0,c=w.length;a<c;a++)w[a].apply(this,arguments)},initNode:function(b,a,c,d,f,g){for(var" l="0,e=x.length;l<e;l++)x[l].apply(this,arguments)},initRoot:function(b){for(var" d="0,f=a[c].length;d<f;d++)arguments.callee(b,a[c][d]);h.getCache(b).nodes[h.getNodeCacheId(a.tId)]=null},removeSelectedNode:function(b,a){for(var" a){if(!a)return[];var="" d.push(a),a[c]&&(d="d.concat(h.transformToArrayFormat(b,a[c])));return" d},transformtoztreeformat:function(b,a){var="" c,d,f="b.data.simpleData.idKey,g=b.data.simpleData.pIdKey,e=b.data.key.children;if(!f||f==""||!a)return[];if(j.isArray(a)){var" h="[],i=[];for(c=0,d=a.length;c<d;c++)i[a[c][f]]=a[c];for(c=0,d=a.length;c<d;c++)i[a[c][g]]&&" a[c][f]!="a[c][g]?(i[a[c][g]][e]||(i[a[c][g]][e]=[]),i[a[c][g]][e].push(a[c])):h.push(a[c]);return" h}else="" return[a]}},m="{bindEvent:function(b){for(var" a,m.proxy);b.bind("dblclick",a,m.proxy);b.bind("mouseover",a,m.proxy);b.bind("mouseout",a,m.proxy);b.bind("mousedown",a,m.proxy);b.bind("mouseup",a,m.proxy);b.bind("contextmenu",a,m.proxy)},unbindtree:function(b){b.treeobj.unbind("click",m.proxy).unbind("dblclick",m.proxy).unbind("mouseover",m.proxy).unbind("mouseout",m.proxy).unbind("mousedown",m.proxy).unbind("mouseup",m.proxy).unbind("contextmenu",m.proxy)},doproxy:function(b){for(var="" a.push(f);if(f.stop)break}return="" a},proxy:function(b){var="" g="a[d];g.nodeEventCallback&&(c=g.nodeEventCallback.apply(g,[b,g.node])&&c);g.treeEventCallback&&(c=g.treeEventCallback.apply(g,[b,g.node])&&c)}return" c}};f="function(b,a){var" if(j.apply(c.callback.beforeexpand,[c.treeid,="" a],!0)="=!1)return!0;h.getRoot(c).expandTriggerFlag=!0;i.switchNode(c,a);return!0};G=function(b,a){var" [c.treeid,a],!0)&&j.apply(c.callback.onmousedown,[b,c.treeid,a]);return!0};i="function(b,a){var" [b,c.treeid,a]);return="" typeof="" c.callback.onrightclick!="function" };var="" j="{apply:function(b,a,c){return" b="="function"?b.apply(N,a?a:[]):c},canAsync:function(b,a){var" b.async.enable&&a&&a.isparent&&!(a.zasync||a[c]&&a[c].length="">0)},clone:function(b){if(b===null)return null;var a=b.constructor===Array?[]:{},c;for(c in b)a[c]=b[c]instanceof Date?new Date(b[c].getTime()):typeof b[c]==="object"?arguments.callee(b[c]):b[c];return a},eqs:function(b,a){return b.toLowerCase()===
...
u=r=null;G=!1;i=g;f=p.getSettings();for(var B in f)if(f[B].treeId&&f[B].edit.enable&&f[B].treeId!=g.treeId&&(b.target.id==f[B].treeId||k(b.target).parents("#"+f[B].treeId).length>0))G=!0,i=f[B];B=x.scrollTop();j=x.scrollLeft();l=i.treeObj.offset();a=i.treeObj.get(0).scrollHeight;f=i.treeObj.get(0).scrollWidth;c=b.clientY+B-l.top;var o=i.treeObj.height()+l.top-b.clientY-B,n=b.clientX+j-l.left,H=i.treeObj.width()+l.left-b.clientX-j;l=c<g.edit.drag.bordermax&&c>g.edit.drag.borderMin;var s=o<g.edit.drag.bordermax&& o="">g.edit.drag.borderMin,I=n<g.edit.drag.bordermax&&n>g.edit.drag.borderMin,C=H<g.edit.drag.bordermax&&h>g.edit.drag.borderMin,o=c>g.edit.drag.borderMin&&o>g.edit.drag.borderMin&&n>g.edit.drag.borderMin&&H>g.edit.drag.borderMin,n=l&&i.treeObj.scrollTop()<=0,h=s&&i.treeobj.scrolltop()+i.treeobj.height()+10>=a,M=I&&i.treeObj.scrollLeft()<=0,n=c&&i.treeobj.scrollleft()+i.treeobj.width()+10>=f;if(b.target.id&&i.treeObj.find("#"+b.target.id).length>0){for(var A=b.target;A&&A.tagName&&!h.eqs(A.tagName,"li")&&
...
a.setEditable=function(a){b.edit.enable=a;return this.refresh()}});var K=e.cancelPreSelectedNode;e.cancelPreSelectedNode=function(b,a){for(var c=p.getRoot(b).curSelectedList,d=0,f=c.length;d</1?(h.isparent=!1,h.open=!1,a=k("#"+h.tid+d.id.ul),q=k("#"+h.tid+d.id.switch),g=k("#"+h.tid+d.id.icon),e.replaceswitchclass(h,q,d.folder.docu),></m;n++)j[g][n].tid==a.tid&&(y=n);if(q==d.move.type_inner){a[g]||(a[g]=[]);if(a[g].length></m;n++)if(h[g][n].tid==c.tid){x=n;break}x></e;f++){var></j;l++){if(n[l].editnameflag&&h.eqs(o.tagname,></l;a++)e.selectnode(i,m[a],a></l;a++)j=m[a],j.isparent&&z.dragnodeshowbefore[j.tid]&&!j.open&&(e.expandcollapsenode(g,></=1.2)&&a?(a=1-t.width(),l=l==null||w.isparent&&w.open?s+c.height()-t.height()></i.treeobj.offset().left&&i.treeobj.scrollleft(i.treeobj.scrollleft()+r.offset().left-i.treeobj.offset().left)}y.css({top:b.clienty+b+3+"px",left:b.clientx+j+3+"px"});l=a=0;if(r&&r.attr("id")!=i.treeid){var></c;a++)if(f=m[a],a.id===f.tid){o=!1;break}else></=0,n=c&&i.treeobj.scrollleft()+i.treeobj.width()+10></=0,h=s&&i.treeobj.scrolltop()+i.treeobj.height()+10></g.edit.drag.bordermax&&h></g.edit.drag.bordermax&&n></g.edit.drag.bordermax&&></g.edit.drag.bordermax&&c></c;a++)if(f=m[a],f.editnameflag=!1,e.selectnode(g,f,a></c;a++)if(z.dragnodeshowbefore[s[a].tid]!==void></g.edit.drag.minmovesize&&math.abs(l-b.clienty)<g.edit.drag.minmovesize)return!0;var></2){h=1;break}else></e;k++)a[k].nocheck!==!0&&a[k].chkdisabled!==!0&&a[k][h]!=a[k].checkedold&&b.push(a[k]),g.gettreechangecheckednodes(c,a[k][d],b);return></o;f++){if(a[f].nocheck!==!0&&a[f].chkdisabled!==!0&&a[f][k]==b&&(d.push(a[f]),e))break;g.gettreecheckednodes(c,a[f][h],b,d);if(e&&d.length></2:a.check_child_state></d;b++)g.getnodecache(c,a[b].tid)||(a.splice(b,1),b--,d--);return></l&&a.chkdisabled!==!0;o++){var></j;k++)e.repairsonchkdisabled(c,a[h][k],b,d)}},repairparentchkdisabled:function(c,></1?d.full:d.part:a[b]?a.check_child_state===2||a.check_child_state===-1?d.full:d.part:a.check_child_state<1?d.full:d.part,b=c.check.chkstyle+"_"+(a[b]?d.true:d.false)+></h;d++)b=f[k][d],b[j]&&b!=a&&(b[j]=!1,e.setchkclass(c,m("#"+b.tid+i.id.check),b))}else></i;e++)if(c[b][e]==></g;f++)h.removenodecache(b,d[f]);h.removeselectednode(b);delete></a></li></m;k++)g[k]&&i.expandcollapsesonnode(b,g[k],c,e);h.getroot(b).expandtriggerflag=j;i.expandcollapsenode(b,a,c,d,f)},makedomnodeicon:function(b,a,c){var></g;f+=2)l[b.async.otherparam[f]]=b.async.otherparam[f+1];else></g;f++){var></f;d++)if(j.eqs(a.tagname,c[d].tagname)&&a.getattribute(c[d].attrname)!==null)return></i;e++){if(j.apply(c,[a[e],f],!1)){if(d)return></f;d++)b[d].apply(this,arguments)},getbeforea:function(b,a,c){for(var>